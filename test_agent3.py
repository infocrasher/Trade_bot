...
def test_agent3(results: TestResults):
    ...
    try:
        ...
        ok = round(ote['ote_top'], 5) == 1.08764 and round(ote['ote_bottom'], 5) == 1.08428
    ...
    try:
        ...
        ok = round(ote['ote_top'], 5) == 1.09572 and round(ote['ote_bottom'], 5) == 1.09236
        results.check("C2 : OTE Zone Bearish", ok, "Valeurs erronées")
    except Exception as e:
